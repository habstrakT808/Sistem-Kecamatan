...
<div class="btn-group" role="group">
    <a href="{{ route('admin-desa.desa.index') }}" class="btn btn-secondary">
    ...
    <div class="col-md-10">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin-desa.desa.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kode_desa') is-invalid @enderror" id="kode_desa" name="kode_desa" value="{{ old('kode_desa', $desa->kode_desa) }}" readonly>
                                <small class="text-muted">Kode desa tidak dapat diubah</small>
                                @error('kode_desa')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kepala_desa') is-invalid @enderror" id="kepala_desa" name="kepala_desa" value="{{ old('kepala_desa', $desa->kepala_desa) }}" required>
                                @error('kepala_desa')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label for="alamat" class="form-label">Alamat Kantor Desa <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <small class="text-muted">
                                        ...
                                        Koordinat dapat diperoleh dari Google Maps
                                    </small>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('komoditas_unggulan') is-invalid @enderror" id="komoditas_unggulan" name="komoditas_unggulan" rows="2">{{ old('komoditas_unggulan', $desa->komoditas_unggulan) }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('kondisi_sosial_ekonomi') is-invalid @enderror" id="kondisi_sosial_ekonomi" name="kondisi_sosial_ekonomi" rows="3">{{ old('kondisi_sosial_ekonomi', $desa->kondisi_sosial_ekonomi) }}</textarea>
...
@push('scripts')
<script>
    // Script untuk validasi koordinat
    document.addEventListener('DOMContentLoaded', function() {
            ...
            input.addEventListener('blur', function() {
                ...
                if (!isNaN(value)) {
                    if (value < min || value > max) {
                        alert(`Nilai koordinat harus antara ${min} dan ${max}`);
                        input.value = '';
                    }
                }
            });
        ...
        validateCoordinate(latitudeInput, -90, 90);
        validateCoordinate(longitudeInput, -180, 180);
    });
</script>
@endpush