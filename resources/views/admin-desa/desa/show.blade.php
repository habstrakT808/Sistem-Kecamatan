            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="card bg-light h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title text-muted">Total Penduduk</h6>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card bg-light h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title text-muted">Perangkat Desa</h6>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card bg-light h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title text-muted">Aset Desa</h6>
                                <h2 class="text-info mb-0">{{ $totalAset }}</h2>
                                <div class="mt-3">
                                    <small class="text-muted">Total Aset Tercatat</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card bg-light h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title text-muted">Kegiatan</h6>
                                <h2 class="text-warning mb-0">{{ $totalKegiatan }}</h2>
                                <div class="mt-3">
                                    <small class="text-muted">Kegiatan Tahun Ini</small>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function initMap() {
        const desaLocation = { lat: {{ $desa->latitude }}, lng: {{ $desa->longitude }} };
