...
@section('page-title', 'Edit Perangkat: ' . $perangkat->nama_lengkap)
...
<div class="btn-group" role="group">
    ...
    <a href="{{ route('admin.perangkat-desa.riwayat', $perangkat) }}" class="btn btn-secondary">
...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.perangkat-desa.update', $perangkat) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" 
                                   id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $perangkat->nama_lengkap) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror" 
                                   id="jabatan" name="jabatan" value="{{ old('jabatan', $perangkat->jabatan) }}" 
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" 
                                   id="nik" name="nik" value="{{ old('nik', $perangkat->nik) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('desa_id') is-invalid @enderror" id="desa_id" name="desa_id">
                                ...
                                @foreach($desas as $desa)
                                    <option value="{{ $desa->id }}" {{ old('desa_id', $perangkat->desa_id) == $desa->id ? 'selected' : '' }}>
                                        {{ $desa->nama_desa }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin" name="jenis_kelamin">
                                ...
                                <option value="L" {{ old('jenis_kelamin', $perangkat->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('jenis_kelamin', $perangkat->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('jenis_kelamin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" 
                                   id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $perangkat->tempat_lahir) }}" 
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" 
                                   id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $perangkat->tanggal_lahir->format('Y-m-d')) }}">
                            @error('tanggal_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="usia_display" readonly value="{{ \Carbon\Carbon::parse($perangkat->tanggal_lahir)->age }} tahun">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('pendidikan_terakhir') is-invalid @enderror" 
                                   id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir', $perangkat->pendidikan_terakhir) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" 
                                   id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $perangkat->no_telepon) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                  ...
                                  placeholder="Alamat lengkap tempat tinggal">{{ old('alamat', $perangkat->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_mulai_tugas') is-invalid @enderror" 
                                   ...
                                   value="{{ old('tanggal_mulai_tugas', $perangkat->tanggal_mulai_tugas->format('Y-m-d')) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_akhir_tugas') is-invalid @enderror" 
                                   ...
                                   value="{{ old('tanggal_akhir_tugas', $perangkat->tanggal_akhir_tugas ? $perangkat->tanggal_akhir_tugas->format('Y-m-d') : '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('jobdesk') is-invalid @enderror" 
                                  ...
                                  placeholder="Deskripsi tugas dan tanggung jawab...">{{ old('jobdesk', $perangkat->jobdesk) }}</textarea>
                        @error('jobdesk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            ...
                            <option value="tidak_aktif" {{ old('status', $perangkat->status) == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('admin.perangkat-desa.show', $perangkat) }}" class="btn btn-secondary me-md-2">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <small>
                        ...
                        {{ $perangkat->created_at->format('d/m/Y H:i') }}
                    </small>
                </div>
                <div class="mb-3">
                    <small>
                        <strong>Terakhir Diubah:</strong><br>
                        {{ $perangkat->updated_at->format('d/m/Y H:i') }}
                    </small>
                </div>
                @if($perangkat->updatedBy)
                <div class="mb-3">
                    <small>
                        <strong>Diubah Oleh:</strong><br>
                        {{ $perangkat->updatedBy->name }}
                    </small>
                </div>
                @endif
                <div class="mb-3">
                    <small>
                        ...
                        <span class="badge bg-secondary">{{ $perangkat->riwayat->count() }} perubahan</span>
                    </small>
                </div>
            </div>
        </div>
